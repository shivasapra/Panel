                    ...
                    <div class="card">
                            ...
                            <div class="nav-tabs-navigation">
                                <div class="nav-tabs-wrapper">
                                    <ul class="nav nav-tabs" data-tabs="tabs">
                                        <li class="nav-item">
                                            <a class="nav-link active" href="#registration" data-toggle="tab">
                                                <i class="material-icons">account_box</i> Registration
                                                <div class="ripple-container"></div>
                                            </a>
                                        </li>
                                        <li class="nav-item">
                                            <a class="nav-link" href="#accomodation" data-toggle="tab">
                                                <i class="material-icons">store</i> Accomodation
                                                <div class="ripple-container"></div>
                                            </a>
                                        </li>
                                        <li class="nav-item">
                                            <a class="nav-link" href="#conference" data-toggle="tab">
                        ...
                        <div class="card-body">
                            ...
                            <div class="tab-content">
                                ...
                                <div class="tab-pane active" id="accomodation">
                                </div>
